...
TileType tileTypes[numTileTypes] = {
  ...
  // 27: IC-Chip
  TileType {
    .image1 = TileImageSpec { .imageIndex = 18, .frameIndex = 1, .dx = 1, .dy = 0 },
  ...
  // 28: IC-Capacitor
  TileType {
    .image1 = TileImageSpec { .imageIndex = 19, .frameIndex = 1, .dx = 2, .dy = 0 },
...
const uint8_t data_17[] = {
  ...
  0x3a, 0x3a, 0x00, 0x55, 0x50, 0x09, 0x39, 0x33,
  0xd3, 0x3a, 0x3a, 0x00, 0x09, 0x39, 0x33, 0x11,
  0x0d, 0xd3, 0x3a, 0x39, 0x39, 0x33, 0x11, 0x00,
  0x00, 0x0d, 0xd3, 0x39, 0x33, 0x11, 0x00, 0x00,
  0x00, 0x00, 0x0d, 0xd3, 0x11, 0x00, 0x00, 0x00,
...
const uint8_t data_18[] = {
  14, 6, 1, 0, 1, (uint8_t)INDEX_PINK, 1,
  // 0: IC-Chip-Top.png
  ...
  0xa0, 0x05, 0x55, 0x55, 0x55, 0x00, 0x93,
};
