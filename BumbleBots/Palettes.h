...
const uint8_t PALETTE_DARK_TILE = 4;
...
const uint8_t PALETTE_GAP_DEFAULT = 10;
const uint8_t PALETTE_GAP_FILLED = 11;
const uint8_t PALETTE_BLUE_TILE = 12;
