...
const Color palettes[numPalettes][16] = {
  ...
  // Enemy
  { BLACK,  BROWN,  PURPLE, GREEN,  BROWN,  DGRAY,  GRAY,   WHITE,  RED,    ORANGE, YELLOW, LGREEN, BEIGE,  ORANGE, PINK,   BEIGE },
  // Flipped enemy
  { BLACK,  BROWN,  PURPLE, GREEN,  BROWN,  DGRAY,  GRAY,   WHITE,  YELLOW, ORANGE, RED,    LGREEN, BEIGE,  ORANGE, PINK,   BEIGE },
  // Checker/darker tile
